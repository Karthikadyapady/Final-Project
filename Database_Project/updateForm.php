            ...
            <form action="update.php" method="post">
                <ul>
                    <li>
                        ...
                        <input type="text" required class="text" value="<?php echo $Firstname; ?>" name="Firstname" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
                        <input type="text" required class="text" value="<?php echo $Lastname; ?>" name="Lastname" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
                        <input type="text" required class="text" value="<?php echo $Username; ?>" name="Username" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
                        <input type="number" required class="text" value="<?php echo $Age; ?>" name="Age" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
                        <input type="text" required class="text" value="<?php echo $Profession; ?>" name="Profession" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
                        <input type="text" required class="text" value="<?php echo $Apt_type; ?>" name="Apt_type" />
                    </li>
                    <li>
                        <span class="un"><i class="fa fa-user"></i></span>
